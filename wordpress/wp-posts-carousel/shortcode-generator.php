        ...
        <tr>
            <td colspan="2">
                <fieldset style="border:1px solid #dfdfdf;">
                    ...
                    <table cellspacing="5" cellpadding="5">
                        <tr>
                            <td align="left"><?php _e('on mobiles', 'wp-posts-carousel'); ?>:</td>
                            <td>
                                <input type="text" name="items_to_show_mobiles" id="items_to_show_mobiles" value="1" size="5">
                            </td>
                        </tr>
                        <tr>
                            <td align="left"><?php _e('on tablets', 'wp-posts-carousel'); ?>:</td>
                            <td>
                                <input type="text" name="items_to_show_tablets" id="items_to_show_tablets" value="2" size="5">
                            </td>
                        </tr>
                        <tr>
                            <td align="left"><?php _e('on laptops and desktops', 'wp-posts-carousel'); ?>:</td>
                            <td>
