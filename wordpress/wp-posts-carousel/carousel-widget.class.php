...
?>
    ...
    <div>
        <fieldset style="border:1px solid #dfdfdf;padding:10px;">
            <legend><strong><?php _e('Items to show', 'wp-posts-carousel') ?>:</strong></legend>
                <p>
                    <label for="<?php echo $this->get_field_id("items_to_show_mobiles"); ?>"><?php _e("on mobiles", "wp-posts-carousel"); ?>:</label>
                    <br />
                    <input size="5" id="<?php echo $this->get_field_id("items_to_show_mobiles"); ?>" name="<?php echo $this->get_field_name("items_to_show_mobiles"); ?>" type="text" value="<?php echo esc_attr($instance["items_to_show_mobiles"]); ?>" />
                </p>
                <p>
                    <label for="<?php echo $this->get_field_id("items_to_show_tablets"); ?>"><?php _e("on tablets", "wp-posts-carousel"); ?>:</label>
                    <br />
                    <input size="5" id="<?php echo $this->get_field_id("items_to_show_tablets"); ?>" name="<?php echo $this->get_field_name("items_to_show_tablets"); ?>" type="text" value="<?php echo esc_attr($instance["items_to_show_tablets"]); ?>" />
                </p>
                <p>
