 ...
 * runs before the init hook. The init hook is too late for some s, such
...
function dazzling_widgets_init() {
  ...
  register_sidebar(array(
    ...
    'before_widget' => '<div id="%1$s" class="widget featured-story %2$s">',
    'after_widget'  => '</div>',
    'before_title'  => '<span class="featured-label">',
    'after_title'   => '</span>',
  ));
...
/**
 * Add customize css/js into header @t
 */

function customize_css_js(){
  echo '<link href="' . esc_url( get_template_directory_uri() . '/css/font.css' ) . '" rel="stylesheet" type="text/css" />'. "\n";
  echo '<link href="' . esc_url( get_template_directory_uri() . '/css/style.css' ) . '" rel="stylesheet" type="text/css" />'. "\n";
  echo '<link href="' . esc_url( get_template_directory_uri() . '/css/responsive.css' ) . '" rel="stylesheet" type="text/css" />'. "\n";
  echo '<script src="' . esc_url( get_template_directory_uri() . '/js/jquery-ui.js' ) . '"></script>'. "\n";
  echo '<script src="' . esc_url( get_template_directory_uri() . '/js/jquery.bxslider.min.js' ) . '"></script>'. "\n";
}

add_action( 'wp_head', 'customize_css_js' );
/**
