        ...
        <div class="widget tabbed">
            <div class="tabs-wrapper">
                <ul class="post-widget">
                      <li class="active"><a href="#popular-posts" data-toggle="tab"><?php esc_attr_e( 'Most Read', 'dazzling' ); ?></a></li>
                      <li><a href="#recent" data-toggle="tab"><?php esc_attr_e( 'Top Stories', 'dazzling' ); ?></a></li>
