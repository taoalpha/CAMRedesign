...
function dazzling_featured_slider() {
    if ( is_front_page() && of_get_option('dazzling_slider_checkbox') == 1 ) {
      echo '<div class="flexslider top-story">';
          ...
          $slidecat = of_get_option('dazzling_slide_categories');
            ...
            if ($query->have_posts()) :
              ...
              // echo '<li>';
                ...
                echo '<div class="flex-caption right">';
									echo '<a href="'. get_permalink() .'">';
									echo '<span class="story-label">Top Story</span>';
									echo '</a>';
                  echo '<a href="'. get_permalink() .'">';
                    //if ( get_the_title() != '' ) echo '<h2 class="entry-title">'. get_the_title().'</h2>';
                    if ( get_the_title() != '' ) echo '<h3><span>'. get_the_title().'</span></h3>';
                    if ( get_the_excerpt() != '' ) echo '<p class="excerpt">' . get_the_excerpt() .'</p>';
                  echo '</a>';
